                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" class="bmeImage" style="padding: 20px; border-collapse: collapse;">
                                                                                                        <img alt="" border="0" class="mobile-img-large" src="https://buenodiaz.com/img/logo-white.png" style="max-width: 560px; display: block; width: 280px;" width="280px"/>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <span>
                                                                                                            <center>
                                                                                                                Bueno&Diaz You have a new purchase request for review.
                                                                                                            </center>
                                                                                                        </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="bmeButton" style="border-collapse: separate;">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <img alt="" border="0" class="mobile-img-large" src="https://buenodiaz.com/img/reloj.png" style="max-width: 280px; display: block; width: 140px;" width="140"/>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    </td>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td class="bmeButtonText" style="border-radius: 0px; border: 0px none transparent; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 6px; padding: 10px 20px; font-weight: bold; background-color: #ff2a57">
                                                                                                                        <span style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 16px; color: rgb(255, 255, 255);">
                                                                                                                            <a href="https://buenodiaz.com/" style="color:#FFFFFF;text-decoration:none; font-size: 14px" target="_blank">
