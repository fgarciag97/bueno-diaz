...
table[name="bmeMainBody"], body {background-color:#eee;}    
...
<body leftmargin="0" marginheight="0" marginwidth="0" style="height: 100% !important; margin: 0; padding: 0; width: 100% !important;min-width: 100%;" topmargin="0">
    <table bgcolor="#eee" border="0" cellpadding="0" cellspacing="0" name="bmeMainBody" style="background-color: rgb(238, 238, 238);" width="100%">
        <tbody>
            <tr>
                            ...
                            <tr>
                                <td name="bmeMainColumnParent" style="border-collapse: separate; border: 0px none transparent; border-radius: 0px;">
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="bmeHolder bmeMainColumn" name="bmeMainColumn" style="max-width: 600px; border-image: initial; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;">
                                        <tbody>
                                            <tr>
                                                <td align="center" bgcolor="" class="blk_container bmeHolder" name="bmePreHeader" style="color: rgb(102, 102, 102); border: 0px none transparent; margin-bottom: 2%" valign="top" width="100%">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="bmeHolder" name="bmeMainContentParent" style="border: 0px none rgb(128, 128, 128); border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;" valign="top" width="100%">
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" bgcolor="#1fc899" class="blk_container bmeHolder" name="bmeHeader" style="border: 0px none transparent; background-color: rgb(103, 211, 182); color: rgb(56, 56, 56);" valign="top" width="100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" class="bmeImage" style="padding-top: 5%; padding-bottom: 0; border-collapse: collapse;">
                                                                                                        <img alt="" border="0" class="mobile-img-large" src="http://buenodiaz.com/img/logo-white.png" style="max-width: 280px; display: block; width: 140px;" width="140px"/>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="bmeButton" style="border-collapse: separate;">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td class="bmeButtonText" style="border-radius: 0px; border: 0px none transparent; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 14px; padding: 20px 40px; font-weight: bold; background-color: rgb(243, 156, 18);">
                                                            ...
                                                            <tr>
                                                                <td align="center" bgcolor="#ffffff" class="blk_container bmeHolder" name="bmePreFooter" style="border: 0px none transparent; background-color: rgb(255, 255, 255);" valign="top" width="100%">
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_14" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_social_follow" style="background-color: rgb(103, 211, 182);" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" name="bmeBadgeText" style="text-align:left; word-break: break-word;">
                                                                                        <span id="spnFooterText" style="font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 11px; line-height: 140%;">
                                                                                            <center>
                                                                                                "Please do not reply, This message has been sent from the official Bueno & Diaz Services Corp Website. ”
                                                                                                <hr>
                                                                                                    <br>
                                                                                                        <strong>
                                                                                                            Developed by:
