...
<body leftmargin="0" marginheight="0" marginwidth="0" style="height: 100% !important; margin: 0; padding: 0; width: 100% !important;min-width: 100%;" topmargin="0">
    <table bgcolor="#a6e9d7" border="0" cellpadding="0" cellspacing="0" name="bmeMainBody" style="background-color: rgb(166, 233, 215);" width="100%">
        <tbody>
            <tr>
                <td align="center" valign="top" width="100%">
                    <table border="0" cellpadding="0" cellspacing="0" name="bmeMainColumnParentTable">
                        <tbody>
                            <tr>
                                <td name="bmeMainColumnParent" style="border-collapse: separate; border: 0px none transparent; border-radius: 0px;">
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="bmeHolder bmeMainColumn" name="bmeMainColumn" style="max-width: 600px; border-image: initial; border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: visible;">
                                        <tbody>
                                            <tr>
                                                <td align="center" bgcolor="" class="blk_container bmeHolder" name="bmePreHeader" style="color: rgb(102, 102, 102); border: 0px none transparent;" valign="top" width="100%">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" class="bmeHolder" name="bmeMainContentParent" style="border: 0px none rgb(128, 128, 128); border-radius: 0px; border-collapse: separate; border-spacing: 0px; overflow: hidden;" valign="top" width="100%">
                                                    <table align="center" border="0" cellpadding="0" cellspacing="0" name="bmeMainContent" style="border-radius: 0px; border-collapse: separate; border-spacing: 0px; border: 0px none transparent;" width="100%">
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" bgcolor="#1fc899" class="blk_container bmeHolder" name="bmeHeader" style="border: 0px none transparent; background-color: rgb(31, 200, 153); color: rgb(56, 56, 56);" valign="top" width="100%">
                                                                    <div class="blk_wrapper" id="dv_11" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_divider" style="" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="tblCellMain" style="padding: 5px 20px;">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblLine" style="border-top-width: 0px; border-top-style: none; min-width: 1px;" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <span>
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_3" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_image" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" class="bmeImage" style="padding: 20px; border-collapse: collapse;">
                                                                                                        <img alt="" border="0" class="mobile-img-large" src="http://buenodiaz.com/img/logo-white.png" style="max-width: 560px; display: block; width: 280px;" width="280px"/>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_18" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_divider" style="" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_15" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_text" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="bmeContainerRow" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center" class="tdPart" valign="top">
                                                                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="tblText" name="tblText" style="float:left; background-color:transparent;" width="600">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td align="left" class="tblCell" name="tblCell" style="padding: 5px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" valign="top">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            <span style="font-size: 24px; font-family: Tahoma, Arial, Helvetica, sans-serif; color: #ffffff; line-height: 150%;">
                                                                                                                                Distributor of Products for the Home, Office, Restaurants and Industry.
                                                                                                                            </span>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_19" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_divider" style="" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td align="center" bgcolor="#ffffff" class="blk_container bmeHolder bmeBody" name="bmeBody" style="color: rgb(56, 56, 56); border: 0px none transparent; background-color: rgb(255, 255, 255);" valign="top" width="100%">
                                                                    <div class="blk_wrapper" id="dv_22" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_divider" style="" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="tblCellMain" style="padding: 10px 20px;">
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_4" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_divider" style="" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="tblCellMain" style="padding: 10px 20px;">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <span>
                                                                                                            <center>
                                                                                                                Your order has been received. You will be notified as soon as it is reviewed
                                                                                                            </center>
                                                                                                        </span>
                                                                                                    </td>
                                                                                                </tr>
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_20" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_button" style="" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="20">
                                                                                    </td>
                                                                                    <td align="center">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblContainer" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td height="20">
                                                                                                    </td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="bmeButton" style="border-collapse: separate;">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <img alt="" border="0" class="mobile-img-large" src="http://buenodiaz.com/img/a.png" style="max-width: 280px; display: block; width: 140px;" width="140"/>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                                                                                    </td>
                                                            ...
                                                            <tr>
                                                                <td align="center" bgcolor="#ffffff" class="blk_container bmeHolder" name="bmePreFooter" style="border: 0px none transparent; background-color: rgb(255, 255, 255);" valign="top" width="100%">
                                                                    <div class="blk_wrapper" id="dv_10" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_divider" style="" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="tblCellMain" style="padding: 20px;">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="tblLine" style="border-top-width: 2px; border-top-style: solid; min-width: 1px; border-top-color: rgb(241, 241, 241);" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <span>
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_9" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_button" style="" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td width="20">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center">
                                                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="bmeButton" style="border-collapse: separate;">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td class="bmeButtonText" style="border-radius: 0px; border: 0px none transparent; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: 6px; padding: 10px 20px; font-weight: bold; background-color: #ff2a57">
                                                                                                                        <span style="font-family: Tahoma, Arial, Helvetica, sans-serif; font-size: 16px; color: rgb(255, 255, 255);">
                                                                                                                            <a href="http://buenodiaz.com" style="color:#FFFFFF;text-decoration:none; font-size: 14px" target="_blank">
                                                                                                                                Visit Bueno&Diaz here
                                                                                                                            </a>
                                                                                                                        </span>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                    ...
                                                                    <div class="blk_wrapper" id="dv_14" style="">
                                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_social_follow" style="background-color: rgb(31, 200, 153);" width="600">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="tblCellMain" style="padding-top:20px; padding-bottom:20px; padding-left:20px; padding-right:20px;">
                                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="tblContainer mblSocialContain" style="text-align:center;">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td class="tdItemContainer" style="">
                                                                                                        <table border="0" cellpadding="0" cellspacing="0" class="mblSocialContain" style="table-layout: auto;">
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td class="bmeSocialTD" name="bmeSocialTD" valign="top">
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </tbody>
                                                                                                        </table>
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="" class="blk_container bmeHolder" name="bmeFooter" style="color: rgb(102, 102, 102); border: 0px none transparent;" valign="top" width="100%">
                                                    <div class="blk_wrapper" id="dv_16">
                                                        <table border="0" cellpadding="0" cellspacing="0" class="blk" name="blk_footer" style="" width="600">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" class="tblCell" name="tblCell" style="padding:20px;" valign="top">
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" name="bmeBadgeText" style="text-align:left; word-break: break-word;">
                                                                                            ...
                                                                                            <center>
                                                                                                <hr>
                                                                                                    <br>
                                                                                                        ...
                                                                                                        Ing. Fely Garcia - Ing. José Sanchez - Ing. Luis Leal
                                                                                                    </br>
                                                                                                </hr>
                                                                                            </center>
                                                                                        </span>
