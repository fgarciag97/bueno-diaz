        ...
        <footer class="page-footer font-small indigo" style="font-family: initial; background: #001524">
            <div class="container text-center text-md-left">
                <div class="row">
                        ...
                        <hr class="clearfix w-100 d-md-none">
                                <div class="col-md-3 mx-auto" style="text-align: center">
                                    ...
                                    <!--<h5 class="font-weight-bold mt-3 mb-4">
                                        <a style="color: white">↓ Desarrolladores ↓</a>
                                    </h5>
                                    <h5 class="font-weight-bold mt-3 mb-4">
                                        <a class="single_add_to_cart_button button alt">Contactar</a>
                                    </h5>-->
                        ...
                        <hr class="clearfix w-100 d-md-none">
                            <div class="col-md-3 mx-auto" style="text-align: center">
                                ...
                                <ul class="list-unstyled" style="margin: 0 0 1.5em 0em;">
                                    <li>
                                        <a href="files/privacypolicy.pdf" target="_blank" style="color: #c6cc11; font-size: 18px">Privacy Policy</a>
	                                </li>
	                                <li>
	                                    <a href="files/COOKIESPOLICY.pdf" target="_blank" style="color: #c6cc11; font-size: 18px">Cookies Policy</a>
	                                </li>
                                    <li>
                                        <a href="files/Conditions.pdf" target="_blank" style="color: #c6cc11; font-size: 18px">Terms And Conditions</a>
                                    </li>
                                </ul>
                            </div>
                            </hr>
             ...
             <div class="footer-copyright text-center py-3" style="font-size: 14px; color: white">
                ...
                <a class="btn-floating btn-lg btn-ins" type="button" href="http://www.instagram.com" target="_blank" style="color:white"><i class="fab fa-instagram"></i></a>
