<div class="modal fade" id="agregar_empresas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="exampleModalLongTitle" style="color: white;"><strong>Agregar Empresa</strong></h5>
                <hr>
            </div>
                ...
                <?= $this->Form->create(@$nuevo_empresa) ?>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4" style="margin-bottom: 5px;">
                            ...
                            <?= @$this->Form->input('cedula', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'autofocus' => true, 'onKeyPress' => 'return soloNum(event);', 'placeholder' => 'Identificación', 'autocomplete' => 'off', 'required', 'maxlength' => 8]); ?>
                        </div>
                    ...
                    <div class="form-row" style="margin-bottom: 5%;">
                        <div class="form-group col-md-12" style="margin-bottom: 5%;">
                            ...
                            <?= @$this->Form->textarea('nota', ['type' => 'text', 'label' => false, 'class'=> 'form-control', 'placeholder' => 'Perfil', 'autocomplete' => 'off', 'onkeyup' => 'mayus(this);', 'rows' => 3]); ?>
                        </div>
                    </div>
                </div>
